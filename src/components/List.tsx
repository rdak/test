 ...
 * @param props
 */
export const List: React.SFC<IList> = (props) => {
  return (
    <>
      <ul className="list">
        {
 ...
 * @param props
 */
export const Item: React.SFC<{ item: string; onClick?: (tag: string) => void; }> = (props) => {
  return (
    <li
...
/* export const Input: React.SFC<{ onClick: (tag: string) => void; }> = (props) => {
}
 */